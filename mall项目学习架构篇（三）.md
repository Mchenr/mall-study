...
#### 1. 整合SpringSecurity和JWT实现认证和授权（一）

这一节主要是搬迁mall-learning中整合SpringSecurity和JWT的文章。 mall项目通过整合SpringSecurity和JWT实现后台用户的登录和授权功能，同时改造Swagger-UI的配置使其可以自动记住登录令牌进行发送。原地址： https://juejin.im/post/5cf90fa5e51d455d6d5357d3  
...
![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合1.png)
...
#### 2. 整合SpringSecurity和JWT实现认证和授权（二）
...
![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合2.png)**未登录前访问接口**

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合3.png)

**登录后访问接口**

-  进行登录操作：登录帐号test 123456 

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合4.png)

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合5.png)

-  点击Authorize按钮，在弹框中输入登录接口中获取到的token信息 

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合6.png)

-  登录后访问获取权限列表接口，发现已经可以正常访问 

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合7.png)

**访问需要权限的接口**

 由于test帐号并没有设置任何权限，所以他无法访问具有pms:brand:read权限的获取品牌列表接口。 

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合8.png)

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合9.png)

改用其他有权限的帐号登录

 改用admin 123456登录后访问，点击Authorize按钮打开弹框,点击logout登出后再重新输入新token。 

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合10.png)

![](D:\note\target\mall项目学习笔记\笔记截图\jwt整合11.png)
